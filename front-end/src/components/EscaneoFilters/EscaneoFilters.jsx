...
import EscaneoTable from "../EscaneoTable/EscaneoTable";

const EscaneoFilters = () => {
  const universidades = [
    {
      iduniversidad: "1",
  ...
  const handleChangeAnio = (event) => {
    ...
    return new Promise((resolve, reject) => {
      fetch(
        "https://grupociencias.edu.pe:8080/api.grupociencias.admin/api/biblioteca/escaneos/listar/",
        {
          method: "POST",
          headers: {
      ...
      <Container maxWidth="xl">
        ...
        <Grid container spacing={2} sx={{ padding: "0 0 30px 0" }}>
          ...
          <Grid item xs={12} md={8} overflow="auto">
            <EscaneoTable dataTable={dataTable} />
          </Grid>
        </Grid>
      </Container>
    </>

...
const SedeFormUpdate =(properties)=> {

  console.log("properties Sedes",properties.id)
  ...
  const {
    ...
    initialValues: {
      ...
      address: properties.data[0]?.address,
      phone: properties.data[0]?.phone,
      mobile: properties.data[0]?.mobile,
      lat: properties.data[0]?.lat,
      lng: properties.data[0]?.lng,
      img: properties.data[0]?.img
    },
    ...
    onSubmit: (data) => {
      ...
      axios
        .post(
          "http://localhost:3001/sede/postUpdateSede",
          data
        )
        .then((response) => {
